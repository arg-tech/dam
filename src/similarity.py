...
from models import (tokenizer, model,pos_tag, wordnet,s_bert_model)
...
def get_sim_dam3(comp1,comp2):
    embedding1 = s_bert_model.encode(comp1, convert_to_tensor=True)
    embedding2 = s_bert_model.encode(comp2, convert_to_tensor=True)
