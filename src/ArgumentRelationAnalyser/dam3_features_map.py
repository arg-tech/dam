...
text1 = "The government is very slow when it comes to implementing renewable energy industry."
text2 = "The energy industry produces a lot of jobs."


prediction = Dam3ArgumentRelationAnalyzer.get_argument_relation((text1, text2)) 
print(prediction)
